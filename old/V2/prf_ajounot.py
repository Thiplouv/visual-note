...
def addnote (nmn) :
    ...
    not_nom = ttk.Combobox(fr2, values=list_noms)
    not_mat = ttk.Combobox(fr2, values=list_mat)
    not_max = ttk.Combobox(fr2, values=list_max)
    not_max.current(2)
    not_type = ttk.Combobox(fr2, values=list_type)
    not_coef = ttk.Combobox(fr2, values=list_coef)
