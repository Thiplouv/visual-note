...
def checkpass() :
    ...
    if mdpn1 != mdpn2 :
        ...
        mainloop()
    elif mdpold != dico_pass[tuple(idusr)] :
...
def chg_pass(n) :
    ...
    fen_ChgPass.geometry('600x200')
    fen_ChgPass.title("Visualnot'") #titre du logiciel
    fen_ChgPass.geometry("630x720") #resolution de la fenetre
